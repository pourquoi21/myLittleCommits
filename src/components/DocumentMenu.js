        ...
        >
          <div>
            ...
            <p>
              ...
              <br />
              주로 React를 통해 개발을 하고 있으나, TypeScript 외 여타 언어에도
              관심이 있습니다.
            </p>
          </div>
          <div>
            <h3 style={{ marginBottom: "10px" }}>💻프로젝트 <span>[시작 > 프로그램]에서 보실 수 있습니다.</span></h3>
            <hr id="normal_hr" />
            ...
            <p>
              React로 처음 제작한 앱입니다.
              <br />
              API와 .map()을 통해서 모든 데이터를 하드코딩하지 않고도 앱을 만들
              수 있는 React의 기능을 경험했으며,
              <br />
              LocalStorage에 내용을 저장하여 To-do 리스트를 만드는 것을
              익혔습니다.
            ...
            <p>
              ...
              <br />
              특히 레시피 추천 앱은 개인적으로 API를 골라 제작한 앱으로, 이 앱을
              제작하면서 메인 페이지에서 각각의 토이프로젝트로 이동할 때마다 state를
              넘겨주는 것에 더 깊은 이해를 얻고, 익숙해질 수 있는 계기가 되었습니다.
            </p>
            <h4>📁Windows 98 Project</h4>
            <p>
              Windows 98을 경험해 본 사람으로서 비슷한 느낌의 페이지를 만들고 싶었습니다.
              <br />
              순수하게 취향을 반영하여 만들기 시작했으나, 만들면서 프로그램을 만드는 데에는 많은 고려사항이 필요하다는 것도 함께 깨달았습니다. 
              <br />
              특히 변수의 이름을 신경써서 지어야 한다는 것을 앱을 제작하는 중간에 일일이 수정하면서 뼈저리게 알 수 있었고,
              <br />
              프로젝트에 임하기 전에 어떤 기능이 필요할지를 계획하는 단계가 필요하겠다는 것을 이론적으로뿐 아니라 피부로 깨달을 수 있었습니다.
              <br />
              개인 앱을 만들면서 좋은 점은 잘못된 코드가 자칫 일으킬 수 있는 문제를 스스로 해결할 기회를 얻는 것이라 생각합니다.
